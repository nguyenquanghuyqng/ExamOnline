...
--
-- Host: 127.0.0.1    Database: examonline
-- ------------------------------------------------------
...
INSERT INTO `classes_tests` VALUES (2,1),(3,2),(1,3),(4,4);
...
INSERT INTO `classes_user` VALUES (1,3),(1,5),(1,7),(5,143),(5,144),(5,145),(5,146),(5,147),(5,148),(5,149),(5,151),(5,152),(5,153),(5,154),(5,155),(5,156),(5,157);
...
INSERT INTO `results` VALUES (1,6,1,1),(2,7,2,1),(3,8,3,2),(4,9,4,2),(5,10,5,3),(6,9,6,1),(7,NULL,7,3),(8,0,3,3);
...
INSERT INTO `test_question` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(2,6),(2,7),(2,8),(2,9),(2,10),(2,11),(2,12),(2,13),(2,14),(2,15),(3,16),(3,17),(3,18),(3,19),(3,20),(3,21),(3,22),(3,23),(3,24),(3,25),(3,26),(3,27),(3,28),(3,29),(3,30),(4,31),(4,32),(4,33),(4,34),(4,35);
...
INSERT INTO `tests` VALUES (1,'2017-12-01 00:00:00','2017-12-29 10:00:00','00:05:00',5,1,2),(2,'2017-12-01 00:00:00','2017-12-01 00:00:00','00:10:00',10,3,1),(3,'2017-12-01 00:00:00','2017-12-29 00:00:00','01:00:00',15,2,3),(4,'2017-12-01 00:00:00','2017-12-01 00:00:00','00:15:00',5,1,2);
...
INSERT INTO `users` VALUES (1,'admin','123','Nguyễn Quang Huy','1997-06-20','Quảng Ngãi','01668659489','huy.png',1,0),(2,'dieu','123','Lương Xuân Diệu','1995-02-04','Buôn Mê Thuột','01234567654','dieu.png',3,0),(3,'trung','123','Lưu Quang Trung','1997-02-03','Vũng Tàu','01239876780','trung.png',4,1),(4,'hoang','123','Trần Kim Hoàng','1997-04-02','Tp Hồ Chí Minh','01987123429','hoang.png',2,0),(5,'huy','123','Nguyễn Quang Huy','1997-06-20','Quảng Ngãi','01668659489','huy.png',4,1),(6,'15110215','123','Nguyễn Quang Huy','2012-01-01','Quảng Ngãi','01668659489','huy.png',4,1),(7,'Huy','123','Quang Huy','2016-06-06','Quang Ngai','01668659489','huy.png',4,NULL),(143,'15110215','15110215','Nguyễn Quang Huy','1997-02-03','Quảng Ngãi','01668659489','huy.jpg',4,NULL),(144,'15110216','15110216','Nguyễn Quang Huy','1997-02-04','Quảng Ngãi','01668659589','huy.jpg',4,NULL),(145,'15110217','15110217','Nguyễn Quang Huy','1997-02-05','Quảng Ngãi','01668659689','huy.jpg',4,NULL),(146,'15110218','15110218','Nguyễn Quang Huy','1997-02-06','Quảng Ngãi','01668659789','huy.jpg',4,NULL),(147,'15110219','15110219','Nguyễn Quang Huy','1997-02-07','Quảng Ngãi','01668659889','huy.jpg',4,NULL),(148,'15110220','15110220','Nguyễn Quang Huy','1997-02-08','Quảng Ngãi','01668659989','huy.jpg',4,NULL),(149,'15110221','15110221','Nguyễn Quang Huy','1997-02-09','Quảng Ngãi','01668660089','huy.jpg',4,NULL),(151,'15110215','15110215','Nguyễn Quang Huy','1997-02-03','Quảng Ngãi','01668659489','huy.jpg',4,NULL),(152,'15110216','15110216','Nguyễn Quang Huy','1997-02-04','Quảng Ngãi','01668659589','huy.jpg',4,NULL),(153,'15110217','15110217','Nguyễn Quang Huy','1997-02-05','Quảng Ngãi','01668659689','huy.jpg',4,NULL),(154,'15110218','15110218','Nguyễn Quang Huy','1997-02-06','Quảng Ngãi','01668659789','huy.jpg',4,NULL),(155,'15110219','15110219','Nguyễn Quang Huy','1997-02-07','Quảng Ngãi','01668659889','huy.jpg',4,NULL),(156,'15110220','15110220','Nguyễn Quang Huy','1997-02-08','Quảng Ngãi','01668659989','huy.jpg',4,NULL),(157,'15110221','15110221','Nguyễn Quang Huy','1997-02-09','Quảng Ngãi','01668660089','huy.jpg',4,NULL);
...
INSERT INTO `users_subjects` VALUES (3,1),(3,2),(5,2),(7,2),(3,3),(5,3);
...
BEGIN
    ...
    birthday,country, phone, image, roleid)
    value(_username,_pass,_fullname,_birthday,_country,
    _phone,_image,_roleid);
...
BEGIN
    ...
    select T.testid, testtypename, classname, subjectname, datetimestart, datetimeend, numberquestion, time  from tests as T inner join classes_tests as CT 
    on T.testid=CT.testid inner join classes on classes.classid=CT.classid inner join subjects as S on T.subjectid= S.subjectid
...
/*!50001 VIEW `listclassexamview` AS select `c`.`classid` AS `classid`,`c`.`classname` AS `classname`,`s`.`subjectname` AS `subjectname`,`tp`.`testtypename` AS `testtypemame`,`t`.`testid` AS `testid` from ((((`classes` `c` join `classes_tests` `ct` on((`c`.`classid` = `ct`.`classid`))) join `tests` `t` on((`t`.`testid` = `ct`.`testid`))) join `testtypes` `tp` on((`tp`.`testtypeid` = `t`.`testtypeid`))) join `subjects` `s` on((`t`.`subjectid` = `s`.`subjectid`))) */;
...
-- Dump completed on 2017-12-20 18:54:58
