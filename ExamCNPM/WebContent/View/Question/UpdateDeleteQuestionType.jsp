                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                         ...
                         <li class="active">
                        	<a href="">Update & Delete Question Types</a>
                        </li>
                    </ul>
                    <!-- /.breadcrumb -->
...
<!-- 						<table class="table" id="makeEditable" border='1' style="width: 100%" class="table table-hover table-bordered table-striped"> -->
						...
						<ul class="pagination">
							...
							<c:if test="${numberpage==1}">
								...
								<li><a href="UpdateDeleteQuestionType?pageid=${numberpage+1}">&raquo;</a></li>
							</c:if>
							...
							<c:if test="${numberpage>1 && numberpage<maxpageid}">
								<li><a href="UpdateDeleteQuestionType?pageid=${numberpage-1}">&laquo;</a></li>
								<li><a href="UpdateDeleteQuestionType?pageid=1">1</a></li>
								<li><a href="UpdateDeleteQuestionType?pageid=2">2</a></li>
								<li><a href="UpdateDeleteQuestionType?pageid=${numberpage+1}">&raquo;</a></li>
							</c:if>
