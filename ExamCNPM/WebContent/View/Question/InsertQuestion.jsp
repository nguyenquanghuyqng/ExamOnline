                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="well-block">
                                                ...
                                                <form method="POST" action="InsertQuestion?pageid=1" id="addquestion" name="addquestion" enctype="multipart/form-data">
                                                    <!-- Form start -->
                                                    <div class="row">
                                                        <!-- Select Basic -->
                                                        <div class="col-md-12">
                                                                ...
                                                                <div class="control-group" id="fields">
                                                                    ...
                                                                    <form action="InsertOption?pageid=1" method="post" name="add_name" id="add_name">
                                                                        ...
                                                                        <table class="table table-bordered" id="dynamic_field">
                                                                            <tr>
                                                                                <td>
                                                                                    <textarea style="height:80px, width=80%" name="option0" id="option0" placeholder="Enter Option Content" class="form-control name_list"
                                                                                        required></textarea>
                                                                                </td>
