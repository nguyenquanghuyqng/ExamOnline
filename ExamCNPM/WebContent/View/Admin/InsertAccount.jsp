			...
			<div class="main-content-inner">
				...
				<div id="thongbao">
					...
					<form action="#" method="post" name="frmInsertAcc">
						Userid:<br> <input type="text" name="userid" id="userid" readonly><br><br>
						Username:<br> <input type="text" name="username" id="username"><br><br>
						PassWord:<br> <input type="text" name="pass" id="pass"><br><br>
						Fullname:<br> <input type="text" name="fullname" id="fullname"><br><br>
						Birthday:<br> <input type="text" name="birthday" id="birthday"><br><br>
						Country:<br> <input type="text" name="country" id="country"><br><br>
						Phone:<br> <input type="text" name="phone" id="phone"><br><br> 
						Image:<br> <input type="text" name="image" id="image"><br><br> 
						Roleid:<br> <select name="roleid" id="roleid">
