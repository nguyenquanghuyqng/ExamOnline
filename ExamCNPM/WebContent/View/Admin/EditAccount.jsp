            ...
            <div class="main-container ace-save-state" id="main-container">
                ...
                <div id="sidebar" class="sidebar responsive ace-save-state">
                    ...
                    <ul class="nav nav-list">
                        ...
                        <!-- 						Manager Role</span> <b class="arrow fa fa-angle-down"></b> -->
                        <!-- 			</a> <b class="arrow"></b> -->

                        <!-- 				<ul class="submenu"> -->
                        <!-- 					<li class=""><a href="tables.html"> <i -->
                        <!-- 							class="menu-icon fa fa-caret-right"></i> List Account -->
                        <!-- 					</a> <b class="arrow"></b></li> -->
                        <!-- 					<li class=""><a href="tables.html"> <i -->
                        ...
                        <div class="page-content">
                            ...
                            <div class="formInsert" style="margin:30px">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <br> <input type="text" name="pass"><br><br> Fullname:
                                    <br> <input type="text" name="fullname"><br><br> Birthday:
                                    <br> <input type="text" name="birthday"><br><br> Country:
                                    <br> <input type="text" name="country"><br><br> Phone:
                                    <br> <input type="text" name="phone"><br><br> Image:
                                    <br> <input type="text" name="image"><br><br> Roleid:
                                    <br> <input type="text" name="roleid"><br><br>
