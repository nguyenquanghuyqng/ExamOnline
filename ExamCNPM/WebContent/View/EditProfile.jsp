...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
                        ...
                        <link href="Style/css/ChangeAccounts.css" rel="stylesheet" type="text/css">
                                                            ...
                                                            <div class=" col-md-9 col-lg-9 ">
                                                                ...
                                                                <table class="table table-user-information" style="font-size: 20px;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Full name:</td>
                                                                            <td><input type="text" name="fullname" value="<%=u.getFullname()%>"></input>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Date of Birth:</td>
                                                                            <td><input type="text" name="birthday" value="<%=u.getBirthday()%>"></input>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <tr>
                                                                                <td>Home Address:</td>
                                                                                <td><input type="text" name="country" value="<%=u.getCountry()%>"></input>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>Phone Number:</td>
                                                                                <td><input type="text" name="phone" value="<%=u.getPhone()%>"></input>
                                                                                </td>
