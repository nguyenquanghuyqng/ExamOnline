        ...
        <div class="about-w3layouts">
            <div class="container">
                ...
                <div class="col-md-6 col-sm-6 gallery-grids agileits w3layouts gallery-grids2 wow slideInRight">
                    ...
                    <h5>Note:</h5>
                    <p class="para-w3-agile">1. No person will be allowed in an examination room during an examination except the candidates concerned and those supervising the examination.</p>
                    <p class="para-w3-agile">2. Candidates must appear at the examination room at least twenty minutes before the commencement of the examination.
                    </p>
                    <p class="para-w3-agile">......</p>
                    <a href="http://aao.hcmute.edu.vn/Resources/Docs/SubDomain/aao/BaoNT/AVDR/062017/N%E1%BB%98I%20QUY%20PH%C3%92NG%20THI.pdf" class="button-w3layouts hvr-rectangle-out">know more</a>
                </div>
                <div class="clearfix"></div>
