...
<body>
        ...
        <div class="banner-overlay-agileinfo ">
            <div class="topheader" style="height: 60px; background: #77b178">
                <div class="col-md-9 top-header-agile-left" style="margin-top: 20px;">
                    <div class="infoarea" style="color: blue">
                        <span>
                            <i class="fa fa-envelope-o"></i>Email: ic@hcmute.edu.vn</span>
                    </div>
                </div>
                <div class="col-md-3 top-header-agile-left" style="margin-top: 0px;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="width:300px;">
                            <li>
                                <a href="ViewProfile">Account Settings
            ...
            <div class="top-header-agile" style="background: white">
                <div class="col-md-6 top-header-agile-left nav-collapse ">
                    ...
                    <h1>
                        <a href="#">
                            <img class="img-responsive" src="Style/images/spkt.jpg">
                        </a>
                    </h1>
                </div>
                    ...
                    <div class="span7">
                        <div class="title_bloginfo" style="color: red">
                            <h3 style="padding: 10px;text-align: center;">
                                THE EXAM PERFORMANCE PROGRAM </h3>
                            <h4 style="padding: 10px">
                                INFORMATION TECHNOLOGY CENTER </h4>
                        </div>
                        <div class="infoarea" style="text-align: center;">
                            <span>
                                <i class="fa fa-phone"></i>Call Us: (+84 - 8) 38968641 - (+84 - 8) 38961333</span>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="slides">
                            <li>
                                <div class="wthree_banner_info_grid">
                                    <h3>
                                        <span>Genius</span>Welcome to
                                        <br>scholar vision</h3>
    ...
    <div class="about-w3layouts">
        <div class="container">
            <div class="col-md-6 col-sm-6 gallery-grids agileits w3layouts gallery-grids1 wow slideInLeft">
                <div class="gallery-grid-images agileits w3layouts">
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-1 history-grid-image">
                        <img src="Style/images/a1.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-2 history-grid-image">
                        <img src="Style/images/a2.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-3 history-grid-image">
                        <img src="Style/images/a3.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-4 history-grid-image">
                        <img src="Style/images/a4.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-5 history-grid-image">
                        <img src="Style/images/a5.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="col-md-4 col-sm-4 gallery-grid gallery-grid-6 history-grid-image">
                        <img src="Style/images/a6.jpg" alt="Agileits W3layouts" class="zoom-img">
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 gallery-grids agileits w3layouts gallery-grids2 wow slideInRight">
                <h2 class="tittle-agileits-w3layouts">Exam Rules and Regulations</h2>
                <h5>Note:</h5>
                <p class="para-w3-agile">1. No person will be allowed in an examination room during an examination except the candidates concerned
                    and those supervising the examination.</p>
                <p class="para-w3-agile">2. Candidates must appear at the examination room at least twenty minutes before the commencement of the
                    examination.
                </p>
                <p class="para-w3-agile">......</p>
                <a href="http://aao.hcmute.edu.vn/Resources/Docs/SubDomain/aao/BaoNT/AVDR/062017/N%E1%BB%98I%20QUY%20PH%C3%92NG%20THI.pdf"
                    class="button-w3layouts hvr-rectangle-out">know more</a>
            </div>
            <div class="clearfix"></div>
    ...
    <div class="col-md-6  services-right">
        <div class="services-info">
            ...
            <p class="para-w3-agile white-w3ls">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar tellus sed mauvehicula tempor. In
                hac habitasse platea dictumst. Donec nunc nunc,interdum sed aliquet quis.</p>
        ...
        <div class="container">
            <div class="footer-row w3layouts-agile">
                <div class="col-md-5 footer-grids w3l-agileits">
                    ...
                    <p>
                        <span style="color: rgb(255, 255, 255); font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: 2; text-align: justify; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; display: inline !important; float: none;">
                            The HCMC University of Technology and Education will become a top center of training, research, creativity, innovation and
                            entrepreneurship in Vietnam, on a par with regional and worldwide prestigious universities.&nbsp;</span>
                        <br>
                        <a href="http://hcmute.edu.vn/ArticleId/4d16f05e-8abd-48f5-9874-f6b587d1b514/tam-nhin-su-mang-muc-tieu" target="_blank">Read More »</a>
                    </p>
                    <div class="top-header-agile-right">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.facebook.com/hcmute.spkt/?fref=ts">
                ...
                <div class="col-md-3 footer-grids w3l-agileits">
                    ...
                    <ul>
                        <li>
                            <a href="http://hcmute.edu.vn/TopicId/05b5495a-b97d-4d68-a031-f9f32d18e4e9/tin-tuc-su-kien" target="_blank">News - Events</a>
                        </li>
                        <br>
                        <li>
                            <a href="http://hcmute.edu.vn/TopicId/54273ff8-c1b0-4544-a3d8-a9f1a80bf6ce/tuyen-sinh" target="_blank">Admissions</a>
                        </li>
                        <br>
                        <li>
                            <a href="http://hcmute.edu.vn/TopicId/fdbda501-ddfe-4eac-b060-2ccf1792e0dc/thong-bao" target="_blank">Notification</a>
                        </li>
                        <br>
                        <li>
                            <a href="http://hcmute.edu.vn/TopicId/e5cfd25e-c3d1-465b-a62b-087bb26e3b06/hoc-bong-viec-lam" target="_blank">Scholarships - jobs</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 footer-grids w3l-agileits">
                    <div class="contact-info">
                        <h3 class="nopadding" style="text-transform: uppercase;">Contact us</h3>
                        <p> No 1 Vo Van Ngan Street, Linh Chieu Ward, Thu Duc District, Ho Chi Minh City
                            <br>
                            <i class="fa fa-phone-square"></i> Phone: (+84 - 8) 38968641 - (+84 - 8) 38961333
                            <br>
                            <i class="fa fa-envelope"></i> E-mail:
                            <a class="mail-link" href="mailto: ic@hcmute.edu.vn"> ic@hcmute.edu.vn</a>
                            <br>
                        </p>
                    </div>
                </div>
    ...
    <div class="copyright-wthree">
        <p>Copyright @ 2017 Tests Online . All Rights Reserved | Design by
            <a href="#"> Huy_Trung_Hoàng </a>
        </p>
    </div>
    <!-- //copy-right -->
