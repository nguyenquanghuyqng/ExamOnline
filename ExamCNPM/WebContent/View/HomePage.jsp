        ...
        <div class="banner1" id="home">
            <div class="banner-overlay-agileinfo">
                <div class="topheader" style="height: 60px; background: #77b178">
                    ...
                    <div class="col-md-3 top-header-agile-left" style="margin-top: 15px; font-size: 18px;">
                        <span style="color: skyblue">You are not logged in. </span> <a href="LoginController" style="color: blue">(Login)</a>
                    </div>
                </div>
        ...
        <div class="services-w3-agileits w3agileits-ref">
            ...
            <div class="col-md-6  services-right">
                <div class="services-info">
                    <h3 class="tittle-agileits-w3layouts white-w3ls">Our best services
                    </h3>
                    ...
                    <a href="#" class="button-w3layouts hvr-rectangle-out">Learn
					more</a>
                </div>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="test">
            <div class="container">
                ...
                <div class="col-md-9 test-gr">
                    <div class=" test-gri1">
                        <div id="owl-demo2" class="owl-carousel" style="margin-top: 20px;">
                            <div class="agile">
                                <div class="test-grid">
                                    <div class="col-md-8 test-grid1">
                                        <p class="para-w3-agile">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis. Lorem ipsum dolor .</p>
                                        <h4>Nguyễn Quang Huy</h4>
                                        <span>15110215</span>
                                    </div>
                                    <div class="col-md-4 test-grid2">
                                        <img src="Style/images/huy.jpg" alt="" class="img-r">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="agile">
                                <div class="test-grid">
                                    <div class="col-md-8 test-grid1">
                                        <p class="para-w3-agile">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis. Lorem ipsum dolor.</p>
                                        <h4>Lưu Quang Trung</h4>
                                        <span>15110345</span>
                                    </div>
                                    <div class="col-md-4 test-grid2">
                                        <img src="Style/images/trung.jpg" alt="" class="img-r">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="agile">
                                <div class="test-grid">
                                    <div class="col-md-8 test-grid1">
                                        <p class="para-w3-agile">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis. Lorem ipsum dolor .</p>
                                        <h4>Trần Kim Hoàng</h4>
                                        <span>15110211</span>
                                    </div>
                                    <div class="col-md-4 test-grid2">
                                        <img src="Style/images/hoang.jpg" alt="" class="img-r">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="agile">
                                <div class="test-grid">
                                    <div class="col-md-8 test-grid1">
                                        <p class="para-w3-agile">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis. Lorem ipsum dolor .</p>
                                        <h4>Lương Xuân Diệu</h4>
                                        <span>13110015</span>
                                    </div>
                                    <div class="col-md-4 test-grid2">
                                        <img src="Style/images/adieu.jpg" alt="" class="img-r">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
